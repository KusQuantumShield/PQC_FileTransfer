...
class PQCServer:
    ...
    def __init__(self, app_config: AppConfig, key_manager: KeyManager, max_concurrent_clients: int = 100) -> None:
        """
        PQCServer 객체를 생성합니다.
        ...
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
            ...
            while True:
                try:
                    ...
                    handler = PQCServerHandler(conn, addr, self.file_save_lock, self.config, self.key_manager)
